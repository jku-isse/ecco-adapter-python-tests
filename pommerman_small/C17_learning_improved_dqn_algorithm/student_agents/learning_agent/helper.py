...
def parse_conf():
    ...
    parser = argparse.ArgumentParser(description="Config-File, Epsilon, Number of Episodes")
    ...
    if general_settings["WARMUP"]:
        ...
        algorithm_settings["EXPERIENCE_REPLAY_SIZE"] = warmup_settings["EXPERIENCE_REPLAY_SIZE"]
        algorithm_settings["MIN_EXPERIENCE_REPLAY_SIZE"] = warmup_settings["MIN_EXPERIENCE_REPLAY_SIZE"]
        algorithm_settings["EPS_DECAY"] = warmup_settings["EPS_DECAY"]
