...
class MCTS:
    ...
    def __init__(self, action_space, agent_id, root_state, rollout_depth=0, exploration_weight=10):
    ...
    def choose(self, node):
        ...
        for keys in children.keys():
            print(" (%d, %d) : %f " % (keys[0], keys[1], score(keys)), end=" ")

        print("%d expanded" % self.nodes_expanded)
