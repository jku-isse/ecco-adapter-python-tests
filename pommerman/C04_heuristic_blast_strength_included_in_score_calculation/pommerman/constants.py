...
RESOURCE_DIR = 'resources_unicorn_style/'
FILE_NAMES = [
...
POSSIBLE_ACTIONS = [Action.Stop.value, Action.Up.value, Action.Down.value, Action.Left.value,
                    Action.Right.value, Action.Bomb.value]
